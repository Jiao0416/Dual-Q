"""
文件名：QlearningGreedy.py
方法名：Qlearning-Greedy

功能：单Q表 + LSTM 预测框架下的纯 Greedy 策略。
"""
...
class QlearningGreedy:
    def __init__(self, actions, num_channel, learning_rate=0.5, reward_decay=0.9, e_greedy=1.0):
    ...
    def choose_action_lstm(self, observation, prediction):
        ...
        return self._argmax_action(q_values)
